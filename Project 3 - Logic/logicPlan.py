...
def pacphysicsAxioms(t: int, all_coords: List[Tuple], non_outer_wall_coords: List[Tuple], walls_grid: List[List] = None, sensorModel: Callable = None, successorAxioms: Callable = None) -> Expr:
    ...
    # We follow the algorithm provided above ^
...
def checkLocationSatisfiability(x1_y1: Tuple[int, int], x0_y0: Tuple[int, int], action0, action1, problem):
    ...
    map_sent = [logic.PropSymbolExpr(wall_str, x, y) for x, y in walls_list]
    KB.append(logic.conjoin(map_sent))

    # we basically follow the algorithm provided above ^
...
def positionLogicPlan(problem) -> List:
    ...
    # we basically follow the algorithm described in the page here:
    # https://inst.eecs.berkeley.edu/~cs188/sp22/project3/#question-4-4-points-path-planning-with-logic
...
def foodLogicPlan(problem) -> List:
    ...
    # we basically copy the code from question 4 and make the following changes:
    # https://inst.eecs.berkeley.edu/~cs188/sp22/project3/#question-5-3-points-eating-all-the-food
...
def localization(problem, agent) -> Generator:
    ...
    # we basically follow the algorithm described in the page here:
    # https://inst.eecs.berkeley.edu/~cs188/sp22/project3/#question-6-4-points-localization
...
def mapping(problem, agent) -> Generator:
    ...
    # we basically follow the algorithm described in the page here:
    # https://inst.eecs.berkeley.edu/~cs188/sp22/project3/#question-7-3-points-mapping
...
def slam(problem, agent) -> Generator:
    ...
    # we basically follow the algorithm described in the page here:
    # https://inst.eecs.berkeley.edu/~cs188/sp22/project3/#question-8-4-points-slam
